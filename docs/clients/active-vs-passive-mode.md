...
description: "The difference between active and passive mode in Direct Connect, which ports you need to forward, and why passive mode limits your search results."
sidebar_position: 7
---
