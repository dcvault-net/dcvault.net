...
For a new page, a larger rewrite, or anything you want to discuss first, open an issue on [GitHub](https://github.com/dcvault-net/dcvault.net) or start a thread on the [forum](https://forum.dcvault.net). That way we can agree on the shape before you put in the work.
...
To start a new language, open an issue or a [forum](https://forum.dcvault.net) thread first. A maintainer adds the locale to the config, then you can translate page by page: the files mirror `docs/` under `i18n/<locale>/docusaurus-plugin-content-docs/current/`. You do not have to translate everything at once.
...
By contributing, you agree that your work is published under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/), the same license as the rest of the wiki.
