...
Diese Anleitung bringt dich in wenigen Schritten zu deinem ersten Hub.

## 1. Client wählen

Wähle einen Direct-Connect-Client für dein System. Wenn du unsicher bist, starte mit DC++ unter Windows oder AirDC++ unter Windows oder Linux. Siehe [Client auswählen](/de/docs/clients/choosing-a-client) und die [Client-Liste](/de/docs/clients/dc-clients).
...
:::tip[Lass dir Zeit]
Jeder braucht etwas Zeit, um sich an DC zu gewöhnen. Wenn etwas unklar ist, frag im [Forum](https://forum.dcvault.net).
:::
